...
### The first proposed architecture: Fully Convolutional Optical Character Recognition IFCA ### 
...
def build_model():
	...
	cnn = Conv2D(filters=32, kernel_size=(3, 3), strides=(2, 2), padding="same", activation='relu', kernel_initializer="he_uniform")(cnn)
    cnn = BatchNormalization(renorm=True)(cnn)
	cnn = Conv2D(filters=32, kernel_size=(3, 3), strides=(2, 2), padding="same", activation='relu', kernel_initializer="he_uniform")(cnn)
    cnn = BatchNormalization(renorm=True)(cnn)
	...
	# 4th three Block
    cnn = Conv2D(filters=256, kernel_size=(3, 3), strides=(1, 1), padding="same", activation='relu', kernel_initializer="he_uniform")(cnn)
    cnn = BatchNormalization(renorm=True)(cnn)
	cnn = Conv2D(filters=256, kernel_size=(3, 3), strides=(1, 1), padding="same", activation='relu', kernel_initializer="he_uniform")(cnn)
    cnn = BatchNormalization(renorm=True)(cnn)
	cnn = Conv2D(filters=256, kernel_size=(3, 3), strides=(1, 1), padding="same", activation='relu', kernel_initializer="he_uniform")(cnn)
	...
	# 5th three Block
    cnn = Conv2D(filters=512, kernel_size=(3, 3), strides=(1, 1), padding="same", activation='relu', kernel_initializer="he_uniform")(cnn)
    cnn = BatchNormalization(renorm=True)(cnn)
	cnn = Conv2D(filters=512, kernel_size=(3, 3), strides=(1, 1), padding="same", activation='relu', kernel_initializer="he_uniform")(cnn)
    cnn = BatchNormalization(renorm=True)(cnn)
	cnn = Conv2D(filters=512, kernel_size=(3, 3), strides=(1, 1), padding="same", activation='relu', kernel_initializer="he_uniform")(cnn)
